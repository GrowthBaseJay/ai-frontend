  ...
  if (isUser) {
    return (
      <div className="flex w-full justify-end">
        <div className="max-w-[78%] rounded-2xl border border-[color:var(--gb-border)]/70 bg-[color:var(--gb-surface-2)] px-3 py-2 text-[16px] leading-7 text-[color:var(--gb-text)]">
